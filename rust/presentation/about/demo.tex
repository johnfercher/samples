...
\begin{frame}{Benchmark (v2.0)}
	\begin{figure}
		...
		\addplot plot coordinates {(0, 65.0)};
		
		\legend{Python (68s), Rust (65s)}
...
\begin{frame}{Benchmark Rust (v2.0)}
	\begin{figure}
		\begin{tikzpicture}
		\begin{axis}[
		mbarplot,
		...
		\addplot plot coordinates {(0, 222.0)};
		\addplot plot coordinates {(0, 121.0)};
		\addplot plot coordinates {(0, 88.0)};
		\addplot plot coordinates {(0, 74.0)};
		\addplot plot coordinates {(0, 68.0)};
		\addplot plot coordinates {(0, 66.0)};
		\addplot plot coordinates {(0, 66.0)};
		\addplot plot coordinates {(0, 65.0)};
		
		\legend{1 thread (222s), 2 threads (121s), 3 threads (88s), 4 threads (74s), 5 threads (68s), 6 threads (66s), 7 threads (66s), 8 threads (65s)}
...
\begin{frame}{Sobre os Benchmarks}	
	...
	\begin{itemize}
		...
		\item Python estava utilizando somente 1 núcleo e Rust estava utilizando 8 núcleos;		
